...
/**
 * Checked exception thrown to indicate an error occurred with a {@link IProcessor}.
 * <hr>
 * @author <a href="mailto:christophe.resse@gmail.com">Christophe Resse - Heliosphere</a>
 * @version 1.0.0
 */
public class ProcessorException extends AbstractCheckedException
{
	/**
	...
	/**
	 * Exception thrown to indicate an error occurred with a {@link IProcessor}.
	 */
	 ...
	 */
	public ProcessorException(final Enum<? extends IBundle> key)
	{
		super(key);
	}
	 ...
	 * message.
	 */
	public ProcessorException(final Enum<?> key, final Object... parameters)
	{
	 ...
	 */
	public ProcessorException(final Exception exception)
	{
		super(exception);
	}
	 ...
	 * @param exception Parent exception.
	 */
	public ProcessorException(final String message, final Exception exception)
	{
